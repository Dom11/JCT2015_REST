...
public class GenericDao<T, I extends Serializable>  {
	...
	/**
	 * Creates a new <code>GenericDaoImpl</code> instance for objects of the given type.
	 * 
	 * @param clazz
	 *            the type of the objects to be persisted with the created instance.
	 */
	 ...
	 * @throws DaoException generic data access exception.
	 */
	 ...
	 * 
	 * @param id a unique entity bean primary key attribute.
	 * @throws DaoException
	 */
	public T get(I id) throws DaoException {
		...
		try {
			...
			throw new DaoException("GenericDaoImpl:get : error fetching records", e);
		}
	}
	...
	public void delete(I id) throws DaoException {
		try {
			...
			throw new DaoException("GenericDaoImpl:delete : error removing record", e);
		}
	}
	 ...
	 * 
	 * @param t the entity bean reference.
	 * @throws DaoException with the following possible error codes:
	 */
	public T save(T t) throws DaoException {
		try {
			...
			throw new DaoException("Record was changed by another user", e);
		} catch (Exception e) {
			System.out.println("GenericDaoImpl:save : error persisting record");
			throw new DaoException("GenericDaoImpl:save : error persisting record", e);
		}
	}
	...
	public void flush() throws DaoException {
		try {
			...
			throw new DaoException("GenericDaoImpl:flush : error flushing state", e);
		}
	}
	 ...
	 * 
	 * @throws DaoException
	 * @return all persistent instances of the associated type in one <code>List</code>.
	...
	public List<T> findAll() throws DaoException {
		...
		try {
			...
			throw new DaoException("GenericDaoImpl:findAll : error retieving records", e);
		}
	}
	 ...
	 * 
	 * @param id a the entity bean reference.
	 * @throws DaoException
	 */
	public void refresh(T t) throws DaoException {
		try {
			...
			System.out.println("GenericDaoImpl:refresh : error refreshing state of object");
			throw new DaoException("GenericDaoImpl:refresh : error refreshing state of object",	e);
		}
	}
